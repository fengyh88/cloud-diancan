...
public class ShopImgServiceImpl extends ServiceImpl<ShopImgMapper, ShopImg> implements IShopImgService {
    ...
    public TupleRet addOrEdit(ShopImgAddParam shopImgAddParam) {
        var existModel = baseMapper.selectById(shopImgAddParam.getImgId());
        if (ObjectUtils.isEmpty(existModel)) {
            ...
            //编辑
            existModel.setImgSize(shopImgAddParam.getImgSize());
            existModel.setImgType(shopImgAddParam.getImgType());
            existModel.setImgUrl(shopImgAddParam.getImgUrl());
            existModel.setLinkId(shopImgAddParam.getLinkId());
            existModel.setLinkCate(shopImgAddParam.getLinkCate());
