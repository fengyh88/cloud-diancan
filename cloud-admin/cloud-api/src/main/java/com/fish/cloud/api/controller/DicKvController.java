...
public class DicKvController {
    ...
    public ApiResult add(@RequestBody SysDicKvAddParam sysDicKvAddParam) {
        var ret = sysDicKvService.add(ApiContextHolder.getAuthDto().getShopId(),sysDicKvAddParam);
        return ApiResult.fromTupleRet(ret);
    }
    ...
    public ApiResult edit(@RequestBody SysDicKvAddParam sysDicKvAddParam) {
        var ret = sysDicKvService.edit(ApiContextHolder.getAuthDto().getShopId(),sysDicKvAddParam);
        return ApiResult.fromTupleRet(ret);
    }
    ...
    public ApiResult<List<SysDicKv>> listByDicCode(String dicCode) {
        var dtos = sysDicKvService.listByDicCode(ApiContextHolder.getAuthDto().getShopId(), dicCode);
