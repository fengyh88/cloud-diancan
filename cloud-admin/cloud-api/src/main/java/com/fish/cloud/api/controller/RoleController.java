...
public class RoleController {
    ...
    public ApiResult add(@RequestBody RoleAddParam roleAddParam) {
        var ret = roleService.add(ApiContextHolder.getAuthDto().getShopId(),roleAddParam);
        return ApiResult.fromTupleRet(ret);
    }
    ...
    public ApiResult edit(@RequestBody RoleAddParam roleAddParam) {
        var ret = roleService.edit(ApiContextHolder.getAuthDto().getShopId(),roleAddParam);
        return ApiResult.fromTupleRet(ret);
    }
    ...
    public ApiResult<List<Role>> all() {
        var dtos = roleService.all(ApiContextHolder.getAuthDto().getShopId());
