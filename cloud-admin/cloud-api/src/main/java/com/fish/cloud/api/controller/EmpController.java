...
public class EmpController {
    ...
    public ApiResult add(@RequestBody EmpAddParam empAddParam) {
        var ret = empService.add(ApiContextHolder.getAuthDto().getShopId(),empAddParam);
        return ApiResult.fromTupleRet(ret);
    }
    ...
    public ApiResult edit(@RequestBody EmpAddParam empAddParam) {
        var ret = empService.edit(ApiContextHolder.getAuthDto().getShopId(),empAddParam);
        return ApiResult.fromTupleRet(ret);
    }
    ...
    public ApiResult<List<EmpDto>> all() {
        var dtos = empService.all(ApiContextHolder.getAuthDto().getShopId());
